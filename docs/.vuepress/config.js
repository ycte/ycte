...
export default defineUserConfig({
  ...
  theme: defaultTheme({
    ...
    repo: 'https://github.com/ycte/ycte.github.io',
    repoLabel: 'Github',
    navbar: [
      { text: '首页', link: '/' },
      { text: '关于我♥', link: '/my-heart.html' },
      {
        text: '谨防盗版我♥',
        children: [
          { text: '珊瑚宫心海(T)', link: '/t-f-my-heart/' },
          { text: 'ycte(T)', link: 'https://github.com/ycte' },
          { text: '沫芒宫刑海(F)', link: 'https://github.com/ycte' },
          { text: '净善宫森海(F)', link: 'https://github.com/ycte' }
        ]
      },
      {
        text: '我♥永恒',
        children: [
          ...
          { text: '#净善宫森海 永远的永夜君#', link: 'https://github.com/ycte' },
